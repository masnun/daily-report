...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return '/Users/masnun/Sites/reportapp/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
    /**
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = '/Users/masnun/Sites/reportapp/vendor/filp/whoops/src/Whoops/Handler' . '/../Resources';
        }
